...
import (
	...
	"github.com/bestyourwallet/go-metadium/core/bloombits"
	"github.com/bestyourwallet/go-metadium/core/rawdb"
	"github.com/bestyourwallet/go-metadium/core/state/pruner"
	...
	"github.com/bestyourwallet/go-metadium/eth/filters"
	"github.com/bestyourwallet/go-metadium/eth/gasprice"
	...
	"github.com/bestyourwallet/go-metadium/internal/shutdowncheck"
	...
	"github.com/bestyourwallet/go-metadium/p2p/dnsdisc"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	chainConfig, genesisHash, genesisErr := core.SetupGenesisBlockWithOverride(chainDb, config.Genesis, config.OverrideArrowGlacier, config.OverrideTerminalTotalDifficulty, config.OverrideBokbunja)
...
func makeExtraData(extra []byte) []byte {
	if len(extra) == 0 {
		...
		extra = []byte(fmt.Sprintf("gmet/v%v.%v.%v/%v/%v", params.VersionMajor, params.VersionMinor, params.VersionPatch, runtime.GOOS, runtime.Version()))
	}
