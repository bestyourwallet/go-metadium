...
import (
	...
	"github.com/bestyourwallet/go-metadium/internal/jsre/deps"
	"github.com/bestyourwallet/go-metadium/internal/web3ext"
...
func (c *Console) Welcome() {
	message := "Welcome to the Gmet JavaScript console!\n\n"
